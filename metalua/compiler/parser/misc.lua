...
-- @module metalua.compiler.parser.misc
...
--]]
   ...
   function M.id2string(id)
      ...
      elseif id.tag == "Splice" then
         ...
         return {
            tag = "String",
            { tag = "Index", { tag = "Splice", id[1] }, { tag = "Number", 1 } },
         }
      else
         error("Identifier expected: " .. pp.tostring(id, "nohash"))
      end
   end
